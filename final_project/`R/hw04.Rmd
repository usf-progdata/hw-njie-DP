...
avp_total<-
  avp_reversed %>% 
  rowwise() %>% 
  mutate(ext_tot = mean(c_across(ext1:ext12)),
  ...
  select(ext_tot, agr_tot, con_tot, neg_tot, ope_tot, health_tot, work_tot,
         gpa, age, gender) 
  summary(avp_total)
```
...
#output bitmap plot
ggsave(here::here("output", "figures", "avp_plot.tiff"),
       avp_plot)
#output vector plot
ggsave(here::here("output", "figures", "avp_plot.eps"),
       avp_plot)
#output pdf plot
ggsave(here::here("output", "figures", "avp_plot.pdf"),
       avp_plot)
``` 